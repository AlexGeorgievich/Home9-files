...
//import static works.ToolsForTest.creatTempDir;

// Архивированный файл формата zip содержит 3 тестовых файла разных форматов
// при запуске общего теста OpenZipAndTest происходит разархивирование zip файла
// в тот же каталог  с последующей проверкой структуры и достоверности содержимого
// каждого полученного файла, кроме того, демострационный тест unZipPdfTest() контроля данных
// без извлечения в каталог (только в служебных temp дебрях хранения)
